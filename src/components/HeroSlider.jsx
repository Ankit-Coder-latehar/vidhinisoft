...
const topLogos = [
  ...
  "https://www.glofy.co/new-front/images/clients/client-8.png",
...
const bottomLogos = [
  "https://www.glofy.co/new-front/images/clients/client-14.png",
  "https://www.glofy.co/new-front/images/clients/client-16.png",
  "https://www.glofy.co/new-front/images/clients/client-5.png",
  "https://www.glofy.co/new-front/images/clients/client-14.png",
  "https://www.glofy.co/new-front/images/clients/client-3.png",
];
    ...
    <section className="bg-white py-24 overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <p className="text-center text-lg text-gray-700 mb-16">
          Trusted by numerous brands to scale software engineering teams.
        </p>
        ...
        <div className="relative overflow-hidden mb-12">
          <div
            ref={topRowRef}
            className="flex w-max gap-24 grayscale opacity-70"
          >
